...
export const primary1 = '#FF585D'
export const primary2 = '#FFB259'
export const primary3 = '#2563EB;'
export const primary4 = '#00C1DE'
export const primary5 = '#0072CE'
export const primary6 = '#F2F2F2'
